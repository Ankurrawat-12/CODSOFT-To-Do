...
const page = () => {
    ...
    const [todos, setTodos] = useState([
        // {
        //     description: "wake up at 3:40pm today",
        //     title: "Wake Up ",
        // },
    ]);
    const submitTodo = (e) => {
        ...
        renderTodos = todos.map((todo, index) => {
            return (
                <li key={index} className="text-xl">
                    <p className="text-3xl mr-3 inline-block ">{index + 1})</p>
                    ...
                    <div className="flex justify-center items-center gap-5 mt-4 -mb-4 row">
                        <svg
                    ...
                    <hr className="w-48 h-1 mx-auto mb-4 bg-gray-100 border-0 rounded md:my-10 dark:bg-gray-700"></hr>
                </li>
            );
        });
    }
